...
namespace PCNTEncoderController
{
    ...
    static float mumPerStep[4] = {12.444f, 12.444f, 12.444f, 12.444f}; // TODO: We have 4µm stepsize though I thought 2µm => so 3200steps/250 counts per mm => 12.8 steps per µm

...
//!   			- i2c driver error
// ****************************************************************************
esp_err_t tca9535::TCA9535Init(uint8_t I2C_MASTER_SCL_IO, uint8_t I2C_MASTER_SDA_IO, uint8_t _TCA9535_ADDRESS) 
{
	esp_err_t ret;
 ...
 * --------|--------------------------|----------------|-------|---------------------------|----------|-----|
 */
unsigned char tca9535::TCA9535ReadSingleRegister(tca9535_reg_t address)
{
	uint8_t reg_data = 0;
 ...
 * --------|---------------------------|----------------|-----------------------|------|
 */
esp_err_t tca9535::TCA9535WriteSingleRegister(tca9535_reg_t address, unsigned short regVal)
{
	esp_err_t ret;
...
//!   			- i2c driver error
// ****************************************************************************
esp_err_t tca9535::TCA9535ReadStruct(TCA9535_Register *reg, tca9535_reg_t reg_num)
{
	esp_err_t ret;
...
//!   			- i2c driver error
// ****************************************************************************
esp_err_t tca9535::TCA9535WriteStruct(TCA9535_Register *reg, tca9535_reg_t reg_num)
{
	esp_err_t ret;
	uint8_t reg_data[2];
...
esp_err_t tca9535::TCA9535WriteOutput(TCA9535_Register *reg)
{
	return TCA9535WriteStruct(reg, TCA9535_OUTPUT_REG0);
}

esp_err_t tca9535::TCA9535WritePolarity(TCA9535_Register *reg)
{
	return TCA9535WriteStruct(reg, TCA9535_POLARITY_REG0);
}

esp_err_t tca9535::TCA9535WriteConfig(TCA9535_Register *reg)
{
	return TCA9535WriteStruct(reg, TCA9535_CONFIG_REG0);
}

esp_err_t tca9535::TCA9535ReadInput(TCA9535_Register *reg)
{
	return TCA9535ReadStruct(reg, TCA9535_INPUT_REG0);
}

esp_err_t tca9535::TCA9535ReadOutput(TCA9535_Register *reg)
{
	return TCA9535ReadStruct(reg, TCA9535_OUTPUT_REG0);
}

esp_err_t tca9535::TCA9535ReadPolarity(TCA9535_Register *reg)
{
	return TCA9535ReadStruct(reg, TCA9535_POLARITY_REG0);
}

esp_err_t tca9535::TCA9535ReadConfig(TCA9535_Register *reg)
{

...
struct UC2_3 : PinConfig
{
    ...
    */
    ...
    int MOTOR_A_STEP = GPIO_NUM_13;
    int MOTOR_X_STEP = GPIO_NUM_16;
    int MOTOR_Y_STEP = GPIO_NUM_14;
    int MOTOR_Z_STEP = GPIO_NUM_0;

    int MOTOR_ENABLE = -1;
    bool MOTOR_ENABLE_INVERTED = true;
    bool MOTOR_AUTOENABLE = true;

    int LASER_1 = GPIO_NUM_12;
    int LASER_2 = GPIO_NUM_4;
    int LASER_3 = GPIO_NUM_2;

    int LED_PIN= GPIO_NUM_13;
    int LED_COUNT = 64;
    ...
    // for caliper
    int X_CAL_DATA = GPIO_NUM_32;
    int Y_CAL_DATA = GPIO_NUM_34;
    int Z_CAL_DATA = GPIO_NUM_36;
    ...
    int SPI_SCK = GPIO_NUM_18;
    int SPI_CS = GPIO_NUM_5;

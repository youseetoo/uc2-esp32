...
class OD:
    ...
    # HARD_LIMIT — Per-axis hard-limit (endstop) configuration
    HARDLIMIT_COMMAND = 0x2030
    ...
    BUILD_TIMESTAMP = 0x2508
    MAC_ADDRESS = 0x2509
    COMMANDED_NODE_ID = 0x250A
...
OD_NAMES = {
    ...
    0x2508: 'build_timestamp',
    0x2509: 'mac_address',
    0x250A: 'commanded_node_id',

...
// Soft-limit subsystem removed. SoftLimitData typedef deleted along with
// SOFT_LIMIT_SET handler and sendSoftLimitsToCANDriver(). Only hard limits
// (endstop-based directional lockout) remain.

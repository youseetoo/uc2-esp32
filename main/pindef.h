// Pindefintion for UC2 Standalone board
...
int LED_ARRAY_NUM = 25;

int DIGITAL_PIN_1 = 39; // Sensor SVN
int DIGITAL_PIN_2 = 34; 
int DIGITAL_PIN_3 = 35;
